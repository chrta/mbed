...
typedef struct {                                    /*!< C_CAN0 Structure                                                      */
  ...
  __IO uint32_t  CANIF2_DA1;                        /*!< Message interface 1 data A1                                           */
  __IO uint32_t  CANIF2_DA2;                        /*!< Message interface 1 data A2                                           */
  __IO uint32_t  CANIF2_DB1;                        /*!< Message interface 1 data B1                                           */
  __IO uint32_t  CANIF2_DB2;                        /*!< Message interface 1 data B2                                           */
